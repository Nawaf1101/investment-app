...
$kendo-colors: (
	...
	primary-subtle: #fad1df,
	primary-subtle-hover: #f6afc7,
	primary-subtle-active: #f28daf,
	primary: #e51a5f,
	primary-hover: #dc195b,
	primary-active: #ca1754,
	primary-emphasis: #ec5387,
	primary-on-subtle: #500921,
	on-primary: white,
	primary-on-surface: #730d30,
	secondary-subtle: #cce4f2,
	secondary-subtle-hover: #a6cfe8,
	secondary-subtle-active: #81bbde,
	secondary: #0277bd,
	secondary-hover: #0272b5,
	secondary-active: #0269a6,
	secondary-emphasis: #4199ce,
	secondary-on-subtle: #012a42,
	on-secondary: white,
	secondary-on-surface: #013c5f,
...
@if not ($kendo-enable-color-system) {
	$primary-palette-name: pink !global;
