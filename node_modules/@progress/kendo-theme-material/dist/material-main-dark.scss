...
$kendo-colors: (
	...
	primary-subtle: #20222c,
	primary-subtle-hover: #383b4c,
	primary-subtle-active: #50546d,
	primary: #9fa8da,
	primary-hover: #a7afdd,
	primary-active: #b6bde3,
	primary-emphasis: #777ea4,
	primary-on-subtle: #dde1f2,
	on-primary: black,
	primary-on-surface: #cfd4ed,
	secondary-subtle: #311d23,
	secondary-subtle-hover: #55323e,
	secondary-subtle-active: #7a4859,
	secondary: #f48fb1,
	secondary-hover: #f598b7,
	secondary-active: #f7aac4,
	secondary-emphasis: #b76b85,
	secondary-on-subtle: #fbd8e4,
	on-secondary: black,
	secondary-on-surface: #fac7d8,
...
@if not ($kendo-enable-color-system) {
	$primary-palette-name: indigo !global;
